...
def print_cow():
    ...
    print("""                            ,;.
                     ...
                     ,,,,,,''''''...............
    ;lcccccccccccokdoxkkkkxxxxxdddddddooooooooc.
     .lxdollcc:;,cxdldkkkkkkkkkkkkkkkkkoc;,'..
        :dOOkxxdllxdldkkkkkkkkkkkkkx:.
           .':lodllc;:ldxxxxxxxxxx:
                        :looooooo:
                        ;olllllll:
                   ,:cokOxxO00OkxOkdlc;
                ..lO0KKX0xoooooodOXXK0Ox.
           .......lkkkkc..........,xkkkk.....""")
    print(10 * " " + "[ Cazeho | https://github.com/Cazeho/]\r\n")
...
def version():
    ...
    print("\r\n	\033[ ForgePass.py ]  " + __version__ + "\033\r\n")
    print(__author__+"\r")
    print(__license__)
    print(__version__)
...
def interactive():
    ...
    print("\r\n[+] Insert the information for personalized your password")
